						   ...
						   uint16_t spriteId, uint8_t fromStackPos, const Position& toPos, uint8_t count)
{
	...
	if (Condition* moveItem = Condition::createCondition(CONDITIONID_DEFAULT, CONDITION_EXHAUST, 100, 0, false, 1)) {
							  ...
							  uint32_t tradePlayerId, uint16_t spriteId)
{
	...
	if (Condition* conditiontrade = Condition::createCondition(CONDITIONID_DEFAULT, CONDITION_EXHAUST, 100, 0, false, 1)) {
...
void Game::playerChangeOutfit(uint32_t playerId, Outfit_t outfit)
{
	...
	if (Condition* conditionoutfit = Condition::createCondition(CONDITIONID_DEFAULT, CONDITION_EXHAUST, 1000, 0, false, 1)) {
...
void Game::playerSpeakToNpc(Player* player, const std::string& text)
{
	...
	if (Condition* conditionnpc = Condition::createCondition(CONDITIONID_DEFAULT, CONDITION_EXHAUST, 1500, 0, false, 1)) {
